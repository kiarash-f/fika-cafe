...
function ItemModal({ onClose, children }) {
  ...
  return (
    ...
    >
      <div
        ref={ref}
        className={`fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 ease-in-out bg-slate-900 w-[calc(100vw-25%)] sm:max-w-xl  rounded-xl`}
      >
        {children}
      </div>
    </div>
